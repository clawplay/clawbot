...
if TYPE_CHECKING:
    ...
    from baibo.agent.memory_ingest import ConversationIngestorBase
    from baibo.config.schema import MemoryConfig
...
def create_memory_backend(
    ...
    from baibo.agent.memory_ingest import NullIngestor
    ...
    if config.auto_ingest:
        from baibo.agent.memory_ingest import ConversationIngestor
