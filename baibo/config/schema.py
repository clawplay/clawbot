...
class OpenAPIConfig(BaseModel):
    ...
    api_keys: list[str] = Field(
        default_factory=list
    )  # Allowed API keys (empty = no auth)
    allow_from: list[str] = Field(default_factory=list)  # Allowed user identifiers
    model_name: str = "baibo"  # Model name exposed to clients
...
class Config(BaseSettings):
    ...
    def get_api_base(self, model: str | None = None) -> str | None:
        ...
        from baibo.providers.registry import find_by_name
